    ...
    <div class="container-fluid">
      ...
      <div class="row mb-2 kepala">
        <div class="col text-center">
          ...
          <a class="btn btn-danger btn-lg" href="hapusriwayat.php?&id=<?=$id;?>">Hapus!</a>
          <a class="btn btn-success btn-lg" href="riwayat.php?&id=<?=$id_pengaduan;?>">Batal dan kembali ke daftar riwayat</a>
        </div>
      </div>
