  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark sembunyi" id="napbars">
    <a class="navbar-brand" href="admin.php">
      ...
      if ($_SESSION['user'] == "superadministrator"){
        echo "<b>SuperAdmin</b> || UPTAM";
      }else{
        echo "<b>Admin</b> || UPTAM";
      }
      ?>
    </a>
    ...
    <div class="collapse navbar-collapse justify-content-end text-center" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        ...
        <a class="btn btn-light" href="admin.php">Beranda Admin</a><span class="sepasinav">&nbsp;</span>
        <a class="btn btn-primary" href="pengaduanadmin.php">Tambah Pengaduan</a><span class="sepasinav">&nbsp;</span>
